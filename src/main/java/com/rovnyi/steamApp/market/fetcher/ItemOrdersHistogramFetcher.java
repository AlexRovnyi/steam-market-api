...
public class ItemOrdersHistogramFetcher {
     ...
     */
    public ItemOrdersHistogramFetcher(CountryCode country, Language language, CurrencyCode currency, ItemNameIdProvider provider) {
    ...
    public ItemOrdersHistogram callAPI(String marketHashName) {
        HttpUrl url = new HttpUrl.Builder()
                ...
                .addQueryParameter("item_nameid", provider.get(marketHashName))
                .build();
    ...
    public static class Builder {
        ...
        public @NotNull ItemOrdersHistogramFetcher build() {
            ...
            return new ItemOrdersHistogramFetcher(country, language, currency, provider);
        }
    }
}